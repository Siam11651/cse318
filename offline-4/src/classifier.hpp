...
namespace offline4
{
    ...
    public:
        classifier(const offline4::sample *sample, const std::vector<offline4::token_mapper> *attribute_mappers, const offline4::token_mapper *class_mapper, const offline4::decision_tree_node *tree_root);
